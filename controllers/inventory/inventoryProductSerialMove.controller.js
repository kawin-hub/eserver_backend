...
exports.insertProductSerialMove = async (req, res) => {
    ...
    try {
        ...
        if (matched) {
            ...
            var [inventoryMoveResult, inventoryLocationResult, productModelResult, inventoryProductSerialResult] =
                await Promise.all([
            ...
            if (inventoryMoveResult.code == 1 && productModelResult.code == 1 && inventoryLocationResult.code == 1 && inventoryProductSerialResult.code == 1) {
                var insertProductSerialMoveparams = {
                    inventoryMove: {
                        _id: inventoryMoveResult.data._id,
                    ...
                    inventoryLocation: {
                        origin: {
                            _id:
                                inventoryLocationResult.data[0]._id == inventoryLocation_origin_id
                        ...
                        destination: {
                            _id:
                                inventoryLocationResult.data[0]._id == inventoryLocation_destination_id
                                    ? inventoryLocationResult.data[0]._id
                                    : inventoryLocationResult.data[1]._id,
                            name:
                                inventoryLocationResult.data[0]._id == inventoryLocation_destination_id
